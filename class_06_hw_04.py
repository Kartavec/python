# Class 06
# Task 04
# A  script that creates a basic class Car
# with speed, color, name and is_police as attributes.
# It uses the following methods - go, stop, turn(direction)
# The script also creates subclasses TownCar, SportsCar, Workcar, PoliceCar 
